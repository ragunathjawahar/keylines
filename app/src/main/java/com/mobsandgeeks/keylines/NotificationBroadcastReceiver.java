...
class NotificationBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final SparseIntArray ID_DEFAULT_ICON_ARRAY = new SparseIntArray() {{
        ...
        put(R.id.flipHorizontalImageButton,     R.drawable.ic_flip_horizontal); // TODO 25/10/16 OFF
    ...
    private void toggleFlipH() {
        @DrawableRes int iconRes = (flipHorizontal = !flipHorizontal)
                ? R.drawable.ic_flip_horizontal : R.drawable.ic_flip_horizontal; // TODO 25/10/16 Icon
